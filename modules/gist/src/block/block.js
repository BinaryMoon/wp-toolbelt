	...
	registerBlockType(
		'toolbelt/gist',
		{
			...
			edit( props ) {
				...
				const inputId = `blocks-toolbelt-gist-input-${instanceId}`;

				return (
					<div className="toolbelt-gist components-placeholder">

						<label htmlFor={inputId} className="components-placeholder__label">
							<BlockIcon icon={github_icon} />
							{__( 'Github Gist URL', 'wp-toolbelt' )}
						</label>
